...
export const quotationItemsTable = mongoTable("quotation_items", {
  ...
  vaultType: text("vault_type"),
  vaultSourceType: text("vault_source_type"),
  vaultStockId: integer("vault_stock_id"),
  vaultReference: text("vault_reference"),
  vaultReservationId: integer("vault_reservation_id"),
...
export const quotationCommunicationsTable = mongoTable(
...
export const insertQuotationCommunicationSchema = createInsertSchema(
  quotationCommunicationsTable,
).omit({ id: true, createdAt: true });
export type InsertQuotationCommunication = z.infer<
  typeof insertQuotationCommunicationSchema
>;
export type QuotationCommunication =
  typeof quotationCommunicationsTable.$inferSelect;
...
export const insertProformaInvoiceItemSchema = createInsertSchema(
  proformaInvoiceItemsTable,
).omit({ id: true });
export type InsertProformaInvoiceItem = z.infer<
  typeof insertProformaInvoiceItemSchema
>;
...
export const deliveryChallanItemsTable = mongoTable("delivery_challan_items", {
  ...
  hsnSac: text("hsn_sac"),
  quantity: numeric("quantity").notNull().default("0"),
  dispatchedQty: numeric("dispatched_qty").notNull().default("0"),
  uom: text("uom").notNull().default("Nos"),
  rate: numeric("rate").notNull().default("0"),
  cgstPercent: numeric("cgst_percent").notNull().default("0"),
  sgstPercent: numeric("sgst_percent").notNull().default("0"),
...
export const insertDeliveryChallanSchema = createInsertSchema(
  deliveryChallansTable,
).omit({ id: true, createdAt: true });
export const insertDeliveryChallanItemSchema = createInsertSchema(
...
export const salesInvoicesTable = mongoTable("sales_invoices", {
  ...
  grandTotal: numeric("grand_total").notNull().default("0"),
  discountAmount: numeric("discount_amount").notNull().default("0"),
  transportCharges: numeric("transport_charges").notNull().default("0"),
...
export const insertSalesInvoiceSchema = createInsertSchema(
  salesInvoicesTable,
).omit({ id: true, createdAt: true });
...
export const insertSalesPaymentSchema = createInsertSchema(
  salesPaymentsTable,
).omit({ id: true, createdAt: true });
export type SalesPayment = typeof salesPaymentsTable.$inferSelect;

export const salesReceivableAdjustmentsTable = mongoTable(
  "sales_receivable_adjustments",
  {
    id: serial("id").primaryKey(),
    invoiceId: integer("invoice_id").notNull(),
...
export const insertSalesReceivableAdjustmentSchema = createInsertSchema(
  salesReceivableAdjustmentsTable,
).omit({ id: true, createdAt: true });
export type SalesReceivableAdjustment =
  typeof salesReceivableAdjustmentsTable.$inferSelect;
...
export const salesReturnItemsTable = mongoTable("sales_return_items", {
  ...
  description: text("description"),
  hsnSac: text("hsn_sac"),
  invoicedQty: numeric("invoiced_qty").notNull().default("0"),
  returnedQty: numeric("returned_qty").notNull().default("0"),
  uom: text("uom").notNull().default("Nos"),
  rate: numeric("rate").notNull().default("0"),
  discountPercent: numeric("discount_percent").notNull().default("0"),
  cgstPercent: numeric("cgst_percent").notNull().default("0"),
...
export const insertSalesReturnSchema = createInsertSchema(
  salesReturnsTable,
).omit({ id: true, createdAt: true });
...
export const insertOrganizationDetailsSchema = createInsertSchema(
  organizationDetailsTable,
).omit({ id: true });
export type InsertOrganizationDetails = z.infer<
  typeof insertOrganizationDetailsSchema
>;
